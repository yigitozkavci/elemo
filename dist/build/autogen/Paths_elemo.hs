...
getBinDir = catchIO (getEnv "elemo_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "elemo_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "elemo_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "elemo_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "elemo_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "elemo_sysconfdir") (\_ -> return sysconfdir)
